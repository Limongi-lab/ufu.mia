...
export default function Hero() {
  return (
    <section className="bg-gradient-to-br from-[#5B107D] via-[#7B1FA2] to-[#8C1BA8] text-white relative overflow-hidden">
      <div className="absolute top-0 right-0 w-[550px] h-[550px] bg-white/5 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute -bottom-24 left-10 w-96 h-96 bg-[#F2C744]/15 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-xs border border-white/20 text-[#F2C744] font-black text-xs sm:text-sm tracking-widest uppercase px-4 py-1.5 rounded-full">
